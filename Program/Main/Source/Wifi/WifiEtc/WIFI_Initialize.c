...
{   /*  ID                          Tx Data                 Function            NextStep                WIFI 초기시작 시퀀스 */
    {   INI_SEQ_NULL,               WIFI_TX_NULL,           NULL,               INI_SEQ_NULL            }, // <0> 대기

    {   INI_SEQ_SERVER_CONNECT,     WIFI_TX_NULL,           IniServerConnect,   INI_SEQ_RQST_INFO       }, // <1> 서버연결 확인
    
    {   INI_SEQ_RQST_INFO,          WIFI_TX_RQST_INFO,      IniRqstInfo,        INI_SEQ_ACK_INFO        }, // 부가정보 요청
    {   INI_SEQ_ACK_INFO,           WIFI_TX_NULL,           NULL,               INI_SEQ_SEND_STATUS     }, // ACK 대기
    
    {   INI_SEQ_SEND_STATUS,        WIFI_TX_SEND_FUNC,      IniSendStart,       INI_SEQ_ACK_STATUS      }, // 상태데이터 전송
    {   INI_SEQ_ACK_STATUS,         WIFI_TX_NULL,           NULL,               INI_SEQ_SEND_SENSOR     }, // ACK 대기
    
    {   INI_SEQ_SEND_SENSOR,        WIFI_TX_SEND_SENSOR,    NULL,               INI_SEQ_ACK_SENSOR      }, // 센서데이터 전송
    {   INI_SEQ_ACK_SENSOR,         WIFI_TX_NULL,           NULL,               INI_SEQ_SEND_ERROR      }, // ACK 대기
    
    {   INI_SEQ_SEND_ERROR,         WIFI_TX_SEND_ERR,       IniCheckSkip,       INI_SEQ_ACK_ERROR       }, // 에러데이터 전송
    {   INI_SEQ_ACK_ERROR,          WIFI_TX_NULL,           NULL,               INI_SEQ_SEND_PART       }, // ACK 대기

    #ifdef USER_USE_ACCUMULATE
    {   INI_SEQ_SEND_PART,          WIFI_TX_SEND_PART,      NULL,               INI_SEQ_ACK_PART        }, // 부하데이터 전송
    {   INI_SEQ_ACK_PART,           WIFI_TX_NULL,           NULL,               INI_SEQ_SEND_ACCUMULATE }, // ACK 대기
    #else
    {   INI_SEQ_SEND_PART,          WIFI_TX_SEND_PART,      NULL,               INI_SEQ_ACK_PART        }, // 부하데이터 전송
    {   INI_SEQ_ACK_PART,           WIFI_TX_NULL,           NULL,               INI_SEQ_FINISHED        }, // ACK 대기
    #endif
    
    {   INI_SEQ_SEND_ACCUMULATE,    WIFI_TX_SEND_ACCUMULATE,NULL,               INI_SEQ_ACK_ACCUMULATE  }, // 누적데이터 전송
    {   INI_SEQ_ACK_ACCUMULATE,     WIFI_TX_NULL,           NULL,               INI_SEQ_FINISHED        }, // ACK 대기
    
    {   INI_SEQ_FINISHED,           WIFI_TX_NULL,           IniFinished,        INI_SEQ_NULL            }  // 초기 데이터 전송 완료
};
